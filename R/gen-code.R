...
#' @param has_base_code,has_alternative,has_data A logical. If `TRUE`, the prompt will include instructions to
...
gen_code_single <- function(base_schema, base_code = NULL, alternative = NULL,
  ...
  base_prompt <- prompt_gen_code(has_base_code = has_code, has_alternative = has_alt, has_data = has_data)
