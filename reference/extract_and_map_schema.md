...
Takes a plain English description of a methodology or analysis plan and
uses an LLM to translate it into a structured YAML schema. The output
YAML is designed to be human-readable and editable before being parsed
into R.

## Usage

``` r
extract_and_map_schema(
  text,
  data,
